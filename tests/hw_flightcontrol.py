...
plt.figure(1)
plt.subplot(311)
plt.plot(m.time,u[0].value,'r-',linewidth=2.0)
plt.plot(m.time,u[1].value,'k:',linewidth=2.0)
plt.legend(['Elevator','Thrust'])
plt.ylabel('MV Action')

plt.subplot(312)
plt.plot(m.time,y[0].value,'b:',linewidth=2.0)
#plt.plot(m.time,y[0].tr_hi,'k-')
#plt.plot(m.time,y[0].tr_lo,'k-')
plt.legend(['Air Speed','Upper Trajectory','Lower Trajectory'])

plt.subplot(313)
plt.plot(m.time,y[1].value,'g--',linewidth=2.0)
