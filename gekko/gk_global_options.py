...
global_option_list = ['APPINFO', 'APPINFOCHG', 'APPSTATUS', 'BNDS_CHK', 'COLDSTART',
                      ...
                      'SOLVESTATUS', 'SOLVER', 'SOLVER_EXTENSION', 'SOLVER_EXTENSION_LIBRARY',
                      'SOLVETIME', 'SPECS', 'TIME_SHIFT', 'WEB', 'WEB_MENU', 'WEB_REFRESH']
"""                      
...
'SCALING', 'SENSITIVITY', 'SEQUENTIAL', 'SOLVER', 'SOLVER_EXTENSION', 
'SOLVER_EXTENSION_LIBRARY', 'SPECS', 'SPC_CHART', 'STREAM_LEVEL', 'TIME_SHIFT', 
'WEB', 'WEB_MENU', 'WEB_REFRESH', 'WEB_PLOT_FREQ']
...
class GKGlobalOptions():
    ...
    def __init__(self):
        ...
        self.SOLVER_EXTENSION_LIBRARY = 0
        self.SPC_CHART = 0
        self.SPECS = 1
        self.STREAM_LEVEL = 0
        self.TIME_SHIFT = 1
