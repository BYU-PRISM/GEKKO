...
def reservoirs():
    ...
    assert(hvals == [[19.40299, 19.20641, 19.01394, 19.31262, 19.60511, 19.89159, 19.6849, 19.48247, 19.28424, 19.09014, 18.90011, 18.71408, 18.53199],
...
test_runner.test('Reservoirs', reservoirs)
